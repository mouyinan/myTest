		      ...
		      <div class="panel panel-success">
		           ...
		           <div class="panel-body">
			           ...
			           <div class="form-group">
			                ...
			                <div class="col-md-2">
                              <input type="text" name="food.price" value="<s:property value='food.unitprice'/>" class="form-control input-sm" placeholder="&yen;" required>
                            </div>
                            <div class="form-group">
			                <label class="control-label col-md-3">美食会员价</label>
			                <div class="col-md-2">
                              <input type="text" name="food.vipprice" value="<s:property value='food.unitprice'/>" class="form-control input-sm" placeholder="&yen;" required>
                            </div>
			           </div>
			           <div class="form-group">
